...
//		DummyContent.populateConnectionList();
		foo = new ArrayAdapter<String>(getActivity(),
				android.R.layout.simple_list_item_activated_1, android.R.id.text1,
				directory.directory());

		setListAdapter(foo);
		foo.notifyDataSetChanged();
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(directory.directory().get(position));
	}
